...
├── style.css        → Mise en forme et design responsive
├── script.js        → Interactivité jQuery
...
- **Compétences** — Barres de progression animées via jQuery au scroll
- **Formation** — Accordéon interactif jQuery
- **Expériences & Projets** — Composants React `<ProjectCard />`
- **Contact** — Formulaire React avec validation jQuery
...
- `ContactForm` — Formulaire de contact (validation assurée par jQuery)
...
- Effet de survol sur les tags de compétences
- Validation du formulaire de contact (champs vides + format email)
- Apparition des sections en fade-in au scroll
...
- **Objectif :** Survivre en évitant différents obstacles tout en progressant à travers plusieurs niveaux de difficulté croissante
- **Concepts mis en pratique :** Gestion des événements, manipulation graphique, organisation du code en classes
...
**📧 a.elhamzi5996@uca.ac.ma**<br>
**GitHub : https://github.com/aelhamzi5996**<br>
**Voir Mon CV : https://aelhamzi5996.github.io**
